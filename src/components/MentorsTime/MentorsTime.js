    ...
    render() {
        ...
        return (
            <div className='form-group'>
                ...
                <select id='day' onChange={inputChange('day')} value={values.day}>
                ...
                <input type='time' className='form-contorl' name='From' onChange={inputChange('fromTime')} value={values.fromTime} />
                <label htmlFor='To'>To</label>
                <input type='time' className='form-contorl' name='To' onChange={inputChange('toTime')} value={values.toTime} />
        ...
        return (
            <div className='form-container'>
                ...
                <div className='form-group'>
                    ...
                    <input type='text' className='form-contorl' name='Location' onChange={inputChange('location')} value={values.location} />
                </div>
                <div className='row'>
                    <div className='col-6'>
